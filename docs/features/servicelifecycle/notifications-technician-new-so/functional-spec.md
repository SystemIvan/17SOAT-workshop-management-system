...
| References | Epic 5 plan item #1 (`docs/EPIC-5-notifications-plan-v2.md`, sections 2 and 3; no official RF), `../../../adr/ADR-004-notifications-boundary.md`, `docs/features/notifications-so-finalized/` (pattern reference) |
