...
/**
 * RF22 - HTTP coverage for {@code POST /api/service-orders/{id}/executions/{executionId}/complete}.
 ...
 * as {@code ServiceOrderControllerUpdateProgressTest}, since RF19's Epic 2 authorize step has no HTTP
 * endpoint yet.
 */
@SpringBootTest
class ServiceOrderControllerCompleteExecutionTest {
    ...
    @Test
    void completesAnInProgressExecutionAndReturns200() throws Exception {
        ...
        mockMvc.perform(post("/api/service-orders/{id}/executions/{executionId}/complete",
