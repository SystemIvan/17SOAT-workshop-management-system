package br.com.fiap.workshop_management_system.serviceorder.infrastructure.web;

import br.com.fiap.workshop_management_system.serviceorder.application.dto.AssignTechnicianRequest;
import br.com.fiap.workshop_management_system.serviceorder.application.dto.CreateServiceOrderRequest;
import br.com.fiap.workshop_management_system.serviceorder.application.dto.FinalizeServiceOrderRequest;
...
import br.com.fiap.workshop_management_system.serviceorder.application.dto.ServiceOrderStatusResponse;
import br.com.fiap.workshop_management_system.serviceorder.application.dto.UpdateExecutionProgressRequest;
import br.com.fiap.workshop_management_system.serviceorder.application.usecase.AssignTechnicianUseCase;
import br.com.fiap.workshop_management_system.serviceorder.application.usecase.CompleteExecutionUseCase;
import br.com.fiap.workshop_management_system.serviceorder.application.usecase.CreateServiceOrderUseCase;
import br.com.fiap.workshop_management_system.serviceorder.application.usecase.FinalizeServiceOrderUseCase;
import br.com.fiap.workshop_management_system.serviceorder.application.usecase.GetServiceOrderStatusUseCase;
import br.com.fiap.workshop_management_system.serviceorder.application.usecase.GetServiceOrderUseCase;
import br.com.fiap.workshop_management_system.serviceorder.application.usecase.PerformDiagnosisUseCase;
import br.com.fiap.workshop_management_system.serviceorder.application.usecase.StartExecutionUseCase;
import br.com.fiap.workshop_management_system.serviceorder.application.usecase.UpdateExecutionProgressUseCase;
